...
export default ({ config }: ConfigContext): ExpoConfig => {
  ...
  const widgetGroupIdentifier = `group.${bundleIdentifier}`;
  ...
  return {
    ...
    android: {
      adaptiveIcon: {
        ...
        backgroundImage: "./assets/images/cambialy-background.png",
        monochromeImage: "./assets/images/cambialy-monochrome.png",
      },
    ...
    plugins: [
      "expo-router",
      "./plugins/withFirebaseAppDistribution",
      "./plugins/withIosBuildReactNativeFromSource",
      [
        "expo-font",
        {
          fonts: [
            ...
            "./assets/fonts/Figtree-Black.ttf",
            "./assets/fonts/Figtree-Italic.ttf",
            "./assets/fonts/Figtree-LightItalic.ttf",
            "./assets/fonts/Figtree-MediumItalic.ttf",
            "./assets/fonts/Figtree-SemiBoldItalic.ttf",
            "./assets/fonts/Figtree-BoldItalic.ttf",
            "./assets/fonts/Figtree-ExtraBoldItalic.ttf",
            "./assets/fonts/Figtree-BlackItalic.ttf",
          ],
          android: {
            fonts: [
              {
                ...
                fontDefinitions: [
                  {
                    path: "./assets/fonts/Figtree-Light.ttf",
                    weight: 300,
                  },
                  {
                  ...
                  {
                    path: "./assets/fonts/Figtree-Black.ttf",
                    weight: 900,
                  },
                  {
                    path: "./assets/fonts/Figtree-Italic.ttf",
                    weight: 400,
                    style: "italic",
                  },
                  {
                    path: "./assets/fonts/Figtree-LightItalic.ttf",
                    weight: 300,
                    style: "italic",
                  },
                  {
                    path: "./assets/fonts/Figtree-MediumItalic.ttf",
                    weight: 500,
                    style: "italic",
                  },
                  {
                    path: "./assets/fonts/Figtree-SemiBoldItalic.ttf",
                    weight: 600,
                    style: "italic",
                  },
                  {
                    path: "./assets/fonts/Figtree-BoldItalic.ttf",
                    weight: 700,
                    style: "italic",
                  },
                  {
                    path: "./assets/fonts/Figtree-ExtraBoldItalic.ttf",
                    weight: 800,
                    style: "italic",
                  },
                  {
                    path: "./assets/fonts/Figtree-BlackItalic.ttf",
                    weight: 900,
                    style: "italic",
                  },
                ],
      ...
      [
        "expo-splash-screen",
        {
          ...
          android: {
            image: "./assets/images/cambialy-monochrome.png",
            imageWidth: 156,
          },
          ios: {
            image: "./assets/images/cambialy-monochrome.png",
